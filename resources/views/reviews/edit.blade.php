...
<div class="container">
	<div class="row">
		<div class="col l8 push-l2 m12 grey lighten-4 z-depth-1 ">
				<h3>Editing Review for {{$review->professor->first_name}} {{$review->professor->last_name}}</h3>
				{!! Form::open(['action' => ['ReviewsController@update', $review->id], 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
				<div class="input-field col s12">
					<i class="material-icons prefix">create</i>
          <input id="title" type="text" name="title" maxlength="30" data-length="30" value="{{$review->title}}">
           ...
           @endif
					...
					<div class="input-field col s12">
						...
						<textarea id="body"   name="body" class="materialize-textarea">{{$review->body}}</textarea>
